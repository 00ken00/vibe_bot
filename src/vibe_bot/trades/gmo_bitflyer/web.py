...
LOGGER = logging.getLogger("vibe_bot.trades.gmo_bitflyer.web")
...
class WebApp:
    ...
    def snapshot(self) -> dict[str, object]:
        ...
        return {
            ...
            "gmo_average_order_seconds": self.state.gmo_average_order_seconds,
            "gmo_order_time_metric_count": len(self.state.gmo_order_time_metrics),
            ...
            "quote": {
                "gmo_bid": quote.gmo_bid,
                "gmo_ask": quote.gmo_ask,
                "gmo_bid_vwap": quote.gmo_bid_vwap,
                "gmo_ask_vwap": quote.gmo_ask_vwap,
...
<title>GMO / bitFlyer Arbitrage</title>
<style>
:root {{
  color-scheme: light;
  --bg: #f6f7f9;
...
<main>
  <section class="metrics">
    ...
    <div class="metric"><div class="label">GMO Avg Order Time</div><div id="gmoOrderTime" class="value">--</div><div id="gmoOrderTimeDetail" class="label">recent 0 / 20</div></div>
  ...
  <section class="table">
    <div class="metric"><div class="label">GMO Top Bid / Ask</div><div id="gmoTop" class="small-value">--</div></div>
    <div class="metric"><div class="label">GMO VWAP Sell / Buy</div><div id="gmoDepth" class="small-value">--</div></div>
    ...
    <div class="metric"><div class="label">GMO / bitFlyer Pos</div><div id="exchangePositions" class="small-value">--</div></div>
...
function render() {{
  ...
  setText("gmoOrderTime", seconds(latest.gmo_average_order_seconds));
  setText("gmoOrderTimeDetail", `recent ${{latest.gmo_order_time_metric_count ?? 0}} / 20`);
  ...
  setText("exchangePositions", `${{btc(latest.gmo_position)}} / ${{btc(latest.bitflyer_position)}}`);
